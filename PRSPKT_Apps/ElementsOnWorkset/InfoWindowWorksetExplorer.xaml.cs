...
//                foreach (var catNode in GenCategoryNodes(ind))
//                {
//                    var catNodeItemView = new TreeViewItem()
//                    {
//                        Header = GenCategoryNodes(ind),
//                        Tag = _allElsEls[ind]
//                    };
//                    rootNode.Items.Add(catNodeItemView);
//                }
//            }
...
//            {
//                ++index1;
//                var catNode = new TreeViewItem() { Header = GenNodeName(sList[index1], elementListList[index1].Count), Tag = (object)elementListList[index1] };
//                catNode.Items.Add(GenFamilyNodes(elementListList[index1]));
//                treeViewList.Add(catNode);
...
//        private TreeViewItem[] GenTypeNodes(List<Element> elsOfFam)
//        {
//            var treeViewList = new List<TreeViewItem>();
//            var sList = new List<string>();
//            var elementListList = new List<List<Element>>();
...
//            return treeViewList.ToArray();
//        }
//        private TreeViewItem[] PopulateTreeViewList(List<string> sList, List<List<Element>> elemListList)
//        {
//            var treeViewList = new List<TreeViewItem>();
//            int index1 = -1;
//            foreach (string str in sList)
//            {
//                ++index1;
//                treeViewList.Add(new TreeViewItem() { Header = GenNodeName(sList[index1], elemListList[index1].Count), Tag = (object)elemListList[index1] });
//            }
//            return treeViewList.ToArray();
