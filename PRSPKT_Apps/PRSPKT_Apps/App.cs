...
namespace PRSPKT_Apps
{
    public class App : IExternalApplication
    {
        static void AddRibbonPanel(UIControlledApplication application)
        {
            ...
            PushButtonData pbData2 = new PushButtonData("cmdRenameApartRooms",
                "Переименовать \n помещения ", thisAssemblyPath, "RenameApartRooms.RenameApartRooms");
            ...
            PushButtonData pbData3 = new PushButtonData("cmdDimAxies",
    "Проставить \n размеры ", thisAssemblyPath, "DimAxies.DimAxies");
